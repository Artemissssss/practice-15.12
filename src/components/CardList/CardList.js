...
let data = [{key:0,img:"https://audimediacenter-a.akamaihd.net/system/production/media/83874/images/f62389ba427e1b7eeb42d53962bcc42bc8544dfd/A1911755_blog.jpg?1582557976", model:"2020 Audi S5 Coupe",text:"Lorem ipsum dolor sit amet,consectetur adipiscing elit. Phasellus non finibus risus, vel rhoncus lacus. Pellentesque malesuada commodo velit nec aliquam. Ut lacus justo, imperdiet placerat luctus sed, bibendum sed leo."},
...
function CardList() {
  return (
    <div className={style.CarList}>
        {data.map((car) => {
return (<Card key={car.key} img={car.img} model={car.model} text={car.text} />);
        })}
    </div>
  )
}
